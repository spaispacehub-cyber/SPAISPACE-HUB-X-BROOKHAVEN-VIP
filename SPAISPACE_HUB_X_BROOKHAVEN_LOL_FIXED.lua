...
-- FULL ENGLISH + ROLE KEYS + ADMIN PANEL (FIXED)
-- =====================================================

_G.SPAISPACE_ROLE = "free"

local KEYS = {
    admin = { "SPAI-ADMIN-KEY" },
    premium = { "SPAI-PREMIUM-KEY" },
    free = { "SPAI-FREE-KEY" },
}
...
ScreenGui.Name = "SPAISPACE_KeySystem"
...
Title.Text = "SPAISPACE HUB X BROOKHAVEN LOL"
...
Box.Position = UDim2.fromScale(0.075,0.4)
Box.TextScaled = true
...
Btn.MouseButton1Click:Connect(function()
    local role = resolveRole(Box.Text)
    if role then
        _G.SPAISPACE_ROLE = role
        ScreenGui:Destroy()
        task.spawn(runMain)
    else
