...
Window = Library:CreateWindow({
    Title = "Banana Cat Hub ULTRA PRO",
    Desc = "- Blox Fruit",
    Image = "rbxassetid://106660246932069"
})



-- ==========================================
-- ULTRA PRO VISUAL THEME (GOLD / BLACK)
-- ==========================================
local function ApplyUltraProTheme()
    pcall(function()
        if Library and Library.SetTheme then
            Library:SetTheme({
                ...
                Button             = Color3.fromRGB(255, 205, 0),
                Hover              = Color3.fromRGB(255, 235, 90),
                Toggle             = Color3.fromRGB(255, 205, 0),
                ToggleBackground   = Color3.fromRGB(38, 38, 38),
                Dropdown           = Color3.fromRGB(38, 38, 38),
                DropdownBackground = Color3.fromRGB(22, 22, 22),
                Scrollbar          = Color3.fromRGB(255, 215, 0),
                ...
                for _, desc in ipairs(gui:GetDescendants()) do
                    if desc:IsA("Frame") or desc:IsA("ScrollingFrame") then
                        if desc.BackgroundTransparency < 1 then
                            desc.BackgroundColor3 = Color3.fromRGB(22, 22, 22)
                        end
                    ...
                    elseif desc:IsA("TextButton") then
                        desc.BackgroundColor3 = Color3.fromRGB(255, 215, 0)
                        desc.TextColor3 = Color3.fromRGB(0, 0, 0)
                        pcall(function()
                            desc.AutoButtonColor = true
                        end)
                        desc.MouseEnter:Connect(function()
                            desc.BackgroundColor3 = Color3.fromRGB(255, 235, 90)
                        end)
                    ...
                    elseif desc:IsA("ImageLabel") or desc:IsA("ImageButton") then
                        desc.ImageColor3 = Color3.fromRGB(255, 215, 0)
                    elseif desc:IsA("UIStroke") then
                        desc.Color = Color3.fromRGB(255, 215, 0)
                    end
                end
            end
        end
        ...
        while task.wait(1) do
            for _, obj in ipairs(PlayerGui:GetDescendants()) do
                if obj:IsA("TextLabel") or obj:IsA("TextButton") then
                    ...
                    if t:find("banana") or t:find("hub") then
                        obj.TextColor3 = Color3.fromRGB(255, 215, 0)
                    end
                end
            end
        end
...
Tabs.Info:AddButton({
    ["Title"] = "Banana Community",
    ["Description"] = "Discord",
    ["Callback"] = function()
        setclipboard(tostring("https://discord.gg/chuoihub"))
    end
})
Tabs.Info:AddButton({
    ["Title"] = "Hdanh Hub",
...
Tabs.Info:AddButton({
    ...
    ["Description"] = "Tiktok",
    ["Callback"] = function()
        setclipboard(tostring("tiktok.com/@huy.vuong204"))
    end
})
