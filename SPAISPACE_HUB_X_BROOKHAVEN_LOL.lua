...
local keyLoader = (function()

-- =====================================
-- SPAISPACE HUB X BROOKHAVEN LOL
-- Cyberpunk Neon Key System
-- =====================================

local REQUIRED_KEY = "SPAI-CYBERPUNK-NEON"
local Players = game:GetService("Players")
local LocalPlayer = Players.LocalPlayer

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "CyberpunkKeySystem"
