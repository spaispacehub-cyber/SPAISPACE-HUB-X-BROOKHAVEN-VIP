...
local function showPurchaseDone(productInfo, recipient)
    ...
    modal.Parent           = gui
    corner(modal, 16)
    stroke(modal, Color3.fromRGB(70, 70, 90), 1.5, 0.2)

    -- Title
    lbl(modal, {
        Text  = "Purchase transaction completed",
        Size  = 17,
        Pos   = UDim2.fromOffset(20, 14),
        FS    = UDim2.new(1, -50, 0, 26),
    ...
    xBtn.Position = UDim2.new(1, -12, 0, 10)
    ...
    div.Position = UDim2.fromOffset(15, 44)
    ...
    ch.Size        = UDim2.fromOffset(52, 52)
    ch.Position    = UDim2.fromOffset(28, 56)
    ...
    circ.Parent = ch
    corner(circ, 100)
    stroke(circ, Color3.fromRGB(200, 200, 210), 2.5, 0)
    local chk = Instance.new("ImageLabel")
    chk.Size = UDim2.fromScale(0.65, 0.65)
    ...
    -- "You purchased X." label
    lbl(modal, {
        Text  = "You purchased " .. productInfo.Name .. ".",
        Size  = 14,
        Color = Config.TextSub,
        Pos   = UDim2.fromOffset(96, 66),
        FS    = UDim2.new(1, -116, 0, 32),
        Wrap  = true,
    ...
    -- OK button — wide and short, matches image
    local ok = Instance.new("TextButton")
    ok.Size             = UDim2.new(1, -30, 0, 38)
    ok.Position         = UDim2.fromOffset(15, 148)
...
local function showBuyModal(productInfo, recipient)
    ...
    -- Balance display (top right, before X)
    local balFrame = Instance.new("Frame")
    balFrame.Position = UDim2.new(1, -50, 0, 14)
    ...
    local div = Instance.new("Frame")
    div.Size = UDim2.new(1, -30, 0, 1)
    div.Position = UDim2.fromOffset(15, 46)
    div.BackgroundColor3 = Color3.fromRGB(55, 55, 75)
    div.BorderSizePixel = 0
    div.ZIndex = 3
    div.Parent = modal
    ...
    row.Size = UDim2.new(1, -40, 0, 76)
    row.BackgroundTransparency = 1
    row.Parent = modal

    -- Icon with colored outline matching fruit color
    local iconFrame = Instance.new("Frame")
    iconFrame.Size = UDim2.fromOffset(70, 70)
    iconFrame.BackgroundColor3 = Config.BgDark
    iconFrame.BorderSizePixel = 0
    iconFrame.Parent = row
    corner(iconFrame, 10)
    stroke(iconFrame, productInfo.Outline or Color3.fromRGB(80,80,80), 2, 0)

    local iconImg = Instance.new("ImageLabel")
    iconImg.Size = UDim2.fromOffset(62, 62)
    ...
    textCol.Position = UDim2.fromOffset(84, 0)
    ...
    priceRow.Size = UDim2.fromOffset(200, 24)
    ...
    -- Buy button — wide, short, bright blue like in screenshot
    local buyBtn = Instance.new("TextButton")
    buyBtn.Position         = UDim2.fromOffset(15, 148)
    buyBtn.Size             = UDim2.new(1, -30, 0, 42)
    ...
    lbl(buyBtn, {Text="Buy", Size=16, Z=5, Align=Enum.TextXAlignment.Center, Font=Enum.Font.GothamBold})
