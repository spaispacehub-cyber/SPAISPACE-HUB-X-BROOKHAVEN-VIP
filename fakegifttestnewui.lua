...
local function showPurchaseDone(productInfo, recipient)
    ...
    subLbl.Position = UDim2.fromOffset(30, 154)
...
local function showBuyModal(productInfo, recipient)
    ...
    buyBtn.MouseButton1Click:Connect(function()
        ...
        buyBtn.Active = false
        -- Lock button, fill to full blue, show processing text
        TweenService:Create(fillBar, TweenInfo.new(0.2), {Size = UDim2.new(1, 0, 1, 0)}):Play()
        buyBtn.Text = "Processing..."
        buyBtn.TextColor3 = Color3.fromRGB(200, 200, 255)
        Config.FakeBalance = newBalance
        -- Show gift notification immediately
        showGiftNotification(productInfo.Name, recipient)
        -- After 3s: close buy modal, open purchase completed
