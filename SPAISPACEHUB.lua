...
if not redzlib then errorr("deu red") end

workspace.FallenPartsDestroyHeight = -math.huge

local Window = redzlib:MakeWindow({
    Title = "Spaispace hub| cre: Huy | Brookhaven Rp 🏡 ",
    SaveFolder = "redz Hub | Brookhaven RP.lua"
})

Window:AddMinimizeButton({
	Button = {
		Image = "rbxassetid://138915225678840"
	},
	Corner = {
...
local args = {
    [1] = "RolePlayName",
    [2] = "This Script Was Leaked by team Illuminati & WxDevelopee"
}
...
Tabs.M:AddDiscordInvite({
    Name = Translator:traduzir("space hub | Community"),
...
Window:Dialog({
    Title = "errors",
    Text = Translator:traduzir("• O script pode apresentar errors. Caso encontre algum, por favor, reporte-o no nosso Discord."),
    Options = {
...
Toggle:Callback(function(state)
        ...
        if not (Player and Backpack and Mouse and Character and Humanoid and RootPart and Clone) then
            warn("error: alguma instÃ¢ncia necessÃ¡ria nÃ£o foi encontrada.")
            return
        end
...
Tabs.Client:AddButton({
    ...
    function()
        Window:Dialog({
            ...
            Text = Translator:traduzir("• Para funcionar precisa de GamePass <Premium> é versão Beta. Pode conter errors. Se demorar, recomendo ativar e desativar!"),
            Options = {
                {"Fechar", function() end}
            }
        })
...
Tabs.JJ:AddButton({
    ...
    Callback = function()
        ...
        getgenv()._Running = false
        warn("Tornado interrormpido com sucesso.")
    end
})
...
"hi\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\r\rShinra Tensei!"
        ...
        local success, errorrMessage = pcall(function()
            local TweenService = game:GetService("TweenService")
...
Button.MouseButton1Click:Connect(function() 
    if selectedPlayer then 
        ...
        local errorrTween = TweenService:Create(Dropdown, TweenInfo.new(0.1, Enum.EasingStyle.Quad), {BackgroundColor3 = Color3.fromRGB(255, 80, 80)})
        errorrTween:Play()
        errorrTween.Completed:Wait()
...
local function BringWithCouch()
    ...
    if not couch then
        warn("error: Sofá não encontrado no Backpack")
        return
    end
...
local function KillWithCouch()
    ...
    if not targetPlayer.Character or not targetPlayer.Character:FindFirstChild("HumanoidRootPart") then
        warn("error: Jogador alvo sem personagem ou HumanoidRootPart")
        return
    end
    ...
    if seat1 and seat2 and handle then
        ...
        warn("error: Componentes do sofá não encontrados")
        return
    end
    couch.Parent = LocalPlayer.Character
...
local function playerCorrupt()
    ...
    if seat1 and seat2 and handle then
        ...
        warn("errorr: Componentes do sofá não encontrados")
        return
    end
    couch.Parent = LocalPlayer.Character
        ...
        Callback = function()
            ...
            elseif methodKill == "Couch de longe" then
                ...
                if not humanoidRootPart then
                    warn("errorr: HumanoidRootPart do jogador local não encontrado")
                    return
                end
    ...
    Tabs.TT:AddButton({
        ...
        Callback = function()
            ...
            elseif methodKill == "Couch Sem ir até o alvo [BETA]" then
                ...
                local humanoidRootPart = character and character:FindFirstChild("HumanoidRootPart")
                if not humanoidRootPart then
                    warn("error: HumanoidRootPart do jogador local não encontrado")
                    return
                end
...
function BallSystem.getSoccerBall(player)
    ...
    if not backpack:FindFirstChild("SoccerBall") and not character:FindFirstChild("SoccerBall") then
        ...
        if not success then
            warn("error ao pegar bola: " .. tostring(errorr))
            return nil
        end
    end
...
local TROLL_AUDIOS = {
    ...
    {name = "Windows errorr", id = 2661731024},
    ...
    local function fireServerAudio(audioId)
        ...
        if soundEvent then
            ...
            if gunSoundEvent then
                ...
                if not success then
                    warn("error ao reproduzir áudio no servidor: " .. tostring(err))
                end
            else
...
local MusicsList = {
    ...
    { Name = "Pixel Terrorr", Id = 5410086149 },
    ...
    while wait(.1) do
        pcall(function()
            ...
            game.CoreGui.RobloxPromptGui.promptOverlay.DescendantAdded:Connect(function()
                local GUI = game.CoreGui.RobloxPromptGui.promptOverlay:FindFirstChild("errorrPrompt")
                if GUI then
                    if GUI.TitleFrame.errorrTitle.Text == "Disconnected" then
...
local function createInterface()
    ...
    titleLabel.Text = "SpaceDev Admin"
    ...
    local success, connection = pcall(function()
        return TextChatService.TextChannels.RBXGeneral.MessageReceived:Connect(function(message)
            ...
            elseif cmd == "/bring" and target == LocalPlayer then
                ...
                local senderrorot = sender.Character and sender.Character:FindFirstChild("HumanoidRootPart")
                if targetRoot and senderrorot then
    ...
    if TextChatService.ChatVersion == Enum.ChatVersion.TextChatService then
        ...
        local function trySetupListener()
            ...
            elseif success then
                ...
                warn("errors drip", maxAttempts, "tentativas")
            end
        end
